...
export const metadata: Metadata = {
  ...
  description: 'Порівняй бонуси при реєстрації на Binance, Bybit, OKX, WhiteBIT. До $600 за першу реєстрацію. Актуальні промокоди та реферальні посилання.',
...
const bonusJsonLd = {
  ...
  '@type': 'ItemList',
  name: 'Бонуси при реєстрації на крипто-біржах 2026',
  description: 'Порівняння бонусів за реєстрацію на топових криптовалютних біржах',
  itemListElement: [
    {
      '@type': 'ListItem', position: 1,
      item: {
        '@type': 'Offer',
        name: 'Binance Welcome Bonus',
        description: 'До $600 USDT за реєстрацію та верифікацію',
        price: '600', priceCurrency: 'USD',
    ...
    },
    {
      ...
      item: {
        '@type': 'Offer',
        name: 'Bybit Welcome Bonus',
        description: 'До $30,000 USDT в бонусах для нових користувачів',
        price: '30000', priceCurrency: 'USD',
        seller: { '@type': 'Organization', name: 'Bybit' },
      },
    },
    {
      ...
      item: {
        '@type': 'Offer',
        name: 'OKX Welcome Bonus',
        description: 'Mystery Box до $10,000 за реєстрацію',
        price: '10000', priceCurrency: 'USD',
        seller: { '@type': 'Organization', name: 'OKX' },
      },
    },
  ],
};
...
const EXCHANGES = [
  ...
  },
  {
    ...
    logo: '⚪',
    bonus: 'До $150 USDT',
    bonusDetails: 'Реферальний бонус + бонус за депозит',
    conditions: ['Реєстрація за посиланням', 'Верифікація', 'Депозит від $10'],
    fee: '0.1%',
    feeDiscount: 'Знижки для VIP',
    rating: 4.4,
    badge: '🇺🇦 Для українців',
    badgeColor: 'bg-blue-500',
    affiliate: 'https://whitebit.com/referral/54626c3b-5240-4d39-9784-8e3eda5736de',
    pros: ['Українська біржа', 'Гривня UAH', 'Простий інтерфейс', 'Швидка верифікація'],
  ...
  },
  {
    ...
    conditions: ['Реєстрація за посиланням', 'Депозит від $100', 'Фʼючерсна торгівля'],
    fee: '0.1%',
    feeDiscount: '0.02% для мейкерів',
    rating: 4.6,
    badge: '⚡ Для трейдерів',
  ...
  },
  {
    ...
    fee: '0.08%',
    feeDiscount: 'Найнижча на ринку',
    rating: 4.5,
    badge: '🌐 Web3 платформа',
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-10">
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify(bonusJsonLd) }}
      />
      ...
      <div className="text-center mb-12">
        <span className="inline-block bg-green-100 text-green-700 text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wide mb-4">
          Актуально — Травень 2026
        </span>
        <h1 className="text-4xl md:text-5xl font-black text-gray-900 mb-4">
          🎁 Бонуси при реєстрації
        </h1>
        <p className="text-gray-500 text-lg max-w-2xl mx-auto">
          Порівняй бонуси топових бірж. Реєструйся за нашими посиланнями і отримай максимальний бонус.
        </p>
      </div>
      ...
      <div className="bg-gradient-to-r from-orange-500 to-orange-600 rounded-2xl p-6 mb-10 text-white text-center">
        ...
        <p className="text-5xl font-black mb-2">До $40,750</p>
      ...
      <div className="bg-white border border-gray-100 rounded-2xl p-6 mb-8">
        ...
        <div className="space-y-4">
          {[
            ...
            { q: 'Чи потрібна верифікація для бонусу?', a: 'На більшості бірж KYC верифікація обовʼязкова для виведення коштів і отримання повного бонусу.' },
            { q: 'Скільки часу займає реєстрація?', a: 'Реєстрація займає 5 хвилин. Верифікація — від 30 хвилин до 24 годин.' },
            { q: 'Бонуси дійсно безкоштовні?', a: 'Так, реєстрація безкоштовна. Деякі бонуси вимагають першого депозиту або торгового обʼєму.' },
          ].map(({ q, a }) => (
      ...
      <p className="text-center text-xs text-gray-400">
        * Розміри бонусів можуть змінюватись. Актуальна інформація на сайтах бірж. Не є фінансовою порадою.
      </p>
    </div>
  );
}

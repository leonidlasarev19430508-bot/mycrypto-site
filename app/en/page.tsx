...
const LABELS = {
  ...
  en: { title: '📊 Exchange Fee Comparison', subtitle: 'Current rates for top crypto exchanges — May 2026', exchange: 'Exchange', spot: 'Spot', futures: 'Futures', withdrawal: 'Withdrawal', coins: 'Coins', bonus: 'Bonus', register: 'Register →', top: 'Top', more: '🎁 More about registration bonuses →', bonusLink: '/bonuses' },
  pl: { title: '📊 Porównanie opłat giełd', subtitle: 'Aktualne stawki topowych giełd krypto — Maj 2026', exchange: 'Giełda', spot: 'Spot', futures: 'Futures', withdrawal: 'Wypłata', coins: 'Monety', bonus: 'Bonus', register: 'Rejestracja →', top: 'Top', more: '🎁 Więcej o bonusach rejestracyjnych →', bonusLink: '/bonuses' },
  de: { title: '📊 Börsengebühren Vergleich', subtitle: 'Aktuelle Tarife der Top-Kryptobörsen — Mai 2026', exchange: 'Börse', spot: 'Spot', futures: 'Futures', withdrawal: 'Auszahlung', coins: 'Münzen', bonus: 'Bonus', register: 'Registrieren →', top: 'Top', more: '🎁 Mehr über Registrierungsboni →', bonusLink: '/bonuses' },
};
...
export default function ComparisonTable({ locale = 'en' }: Props) {

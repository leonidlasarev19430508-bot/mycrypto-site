  ...
  return (
    <main className="max-w-4xl mx-auto px-4 py-12">
      ...
      <table className="w-full text-left border-collapse mb-6">
        ...
        <tbody>
          <tr className="align-top border-t"><td className="py-2">Binance</td><td className="py-2">DCA and Grid</td><td className="py-2">Free — <a href={getAffiliateLink('binance')} rel="sponsored noopener noreferrer" className="text-orange-600">ref</a></td></tr>
          <tr className="align-top border-t"><td className="py-2">Bybit</td><td className="py-2">DCA, Grid, Martingale</td><td className="py-2">Convenient interface — <a href={getAffiliateLink('bybit')} rel="sponsored noopener noreferrer" className="text-orange-600">ref</a></td></tr>
          ...
          <tr className="align-top border-t"><td className="py-2">KuCoin</td><td className="py-2">DCA and Grid</td><td className="py-2"><a href={getAffiliateLink('kucoin')} rel="sponsored noopener noreferrer" className="text-orange-600">ref</a></td></tr>

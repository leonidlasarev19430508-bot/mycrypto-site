...
const FAQS = {
  uk: [
    ...
    { q: "З якої біржі краще почати новачку?", a: "Для початківців найкраще підходять Binance або KuCoin. Binance — найбільша біржа світу з великою кількістю навчальних матеріалів. KuCoin — біржа з великим вибором монет і простим інтерфейсом. Пройди наш квіз підбору біржі для персональної рекомендації." },
    ...
    { q: "Чи безпечно зберігати крипту на біржі?", a: "Великі біржі (Binance, KuCoin) мають надійний захист, але для великих сум краще використовувати апаратний гаманець (Ledger, Trezor). Завжди вмикай двофакторну автентифікацію (2FA) на біржі." },
  ...
  en: [
    ...
    { q: "Which exchange is best for beginners?", a: "For beginners, Binance or KuCoin are the best options. Binance is the world's largest exchange with extensive educational materials. KuCoin offers a simple interface and a wide selection of coins. Take our exchange quiz for a personalized recommendation." },
    ...
    { q: "Is it safe to store crypto on an exchange?", a: "Large exchanges (Binance, KuCoin) have strong security, but for large amounts it's better to use a hardware wallet (Ledger, Trezor). Always enable two-factor authentication (2FA) on your exchange account." },
  ...
  pl: [
    ...
    { q: "Od której giełdy zacząć jako początkujący?", a: "Dla początkujących najlepsze są Binance lub KuCoin. Binance to największa giełda świata z bogatymi materiałami edukacyjnymi. KuCoin oferuje prosty interfejs i szeroki wybór monet. Przejdź nasz quiz, aby uzyskać spersonalizowaną rekomendację." },
    ...
    { q: "Czy bezpiecznie jest trzymać krypto na giełdzie?", a: "Duże giełdy (Binance, KuCoin) mają solidne zabezpieczenia, ale dla dużych kwot lepiej używać portfela sprzętowego (Ledger, Trezor). Zawsze włączaj uwierzytelnianie dwuskładnikowe (2FA)." },
  ...
  de: [
    ...
    { q: "Welche Börse ist für Anfänger am besten?", a: "Für Anfänger sind Binance oder KuCoin die besten Optionen. Binance ist die weltgrößte Börse mit umfangreichen Lernmaterialien. KuCoin bietet eine einfache Oberfläche und eine große Münzauswahl. Mache unseren Quiz für eine persönliche Empfehlung." },
    ...
    { q: "Ist es sicher, Krypto an einer Börse aufzubewahren?", a: "Große Börsen (Binance, KuCoin) haben starke Sicherheit, aber für große Beträge ist es besser, ein Hardware-Wallet (Ledger, Trezor) zu verwenden. Aktiviere immer die Zwei-Faktor-Authentifizierung (2FA)." },

    ...
    try {
      const res = await fetch('https://api.anthropic.com/v1/messages', {
        ...
        body: JSON.stringify({
          ...
          max_tokens: 400,
          system: 'Ти дружній AI-гід криптовалютного сайту CryptoNavigator. Відповідай коротко (2-4 речення), простою мовою українською. Допомагай новачкам розібратись у криптовалютах. Будь привітним і доступним. Не давай фінансових порад.',
      ...
      setMessages(prev => [...prev, { role: 'assistant', content: '😔 Помилка з\'єднання. Спробуйте пізніше.' }]);
    } finally {
      setLoading(false);
    }
  };
        ...
        <div style={{
          ...
          <div style={{
            ...
            <button
              ...
              style={{ color: '#9ca3af', background: 'none', border: 'none', fontSize: '20px', cursor: 'pointer', lineHeight: 1 }}
            >×</button>
          </div>

    ...
    <header className="bg-black text-white p-4">
      <div className="max-w-6xl mx-auto flex flex-wrap justify-between items-center gap-4">
        ...
        <nav className="flex flex-wrap gap-6 items-center">
          ...
          <Link href="/markets" className="hover:text-gray-300">{t.nav.markets}</Link>
          <Link href="/news" className="hover:text-gray-300">{t.nav.news}</Link>
          <Link href="/assistant" className="hover:text-gray-300">{t.nav.assistant}</Link>

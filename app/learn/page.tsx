    ...
    lessons: [
      ...
      },
      {
        ...
        content: [
          ...
          { type: 'list', title: 'Крок за кроком:', items: ['Вибери біржу (Binance або KuCoin)', 'Зареєструйся і пройди верифікацію', 'Поповни рахунок карткою', 'Вибери криптовалюту і купи'] },
      ...
      },
      {
        ...
        content: [
          ...
          { type: 'list', title: 'Де стейкувати:', items: ['На біржі (Binance Earn, KuCoin) — найпростіше', 'В гаманці (MetaMask) — більше контролю', 'В DeFi протоколах — найвищі відсотки але ризики'] },
        ],
      },
      {

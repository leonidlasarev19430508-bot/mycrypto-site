      ...
      <div className="mb-4 border border-gray-200 rounded-xl overflow-hidden">
        ...
        {howOpen && (
          <div className="px-4 py-4 bg-white grid grid-cols-1 md:grid-cols-4 gap-4">
            {[
  { n: '1', icon: '📊', t: 'Дивіться на графік', d: 'Кожна "свічка" — це 15 хвилин торгів. 🟢 Зелена = ціна зросла. 🔴 Червона = ціна впала. Дивіться в який бік рухаються свічки останнім часом.' },
  { n: '2', icon: '🔍', t: 'Прийміть рішення', d: 'Свічки ростуть вгору? → Натисніть "Купити". Свічки падають вниз? → Натисніть "Продати". Не бійтесь помилитись — гроші віртуальні!' },
  { n: '3', icon: '💰', t: 'Відкрийте угоду', d: 'Введіть суму (наприклад $100) і натисніть "Купити" або "Продати". Угода відкрита! Внизу побачите свою позицію.' },
  { n: '4', icon: '📈', t: 'Слідкуйте за P&L', d: 'P&L — це ваш прибуток або збиток. Зелений = ви в плюсі, червоний = в мінусі. Коли бачите бажаний прибуток — натисніть "Закрити".' },
].map(item => (

  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-10">
      <div className="text-center mb-12">
        <span className="inline-block bg-green-100 text-green-700 text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wide mb-4">Aktualne — Maj 2026</span>
        <h1 className="text-4xl md:text-5xl font-black text-gray-900 mb-4">🎁 Bonusy za Rejestrację</h1>
        <p className="text-gray-500 text-lg max-w-2xl mx-auto">Porównaj bonusy topowych giełd. Zarejestruj się przez nasze linki i uzyskaj maksymalny bonus.</p>
      </div>
      <div className="bg-gradient-to-r from-orange-500 to-orange-600 rounded-2xl p-6 mb-10 text-white text-center">
        ...
        <p className="text-5xl font-black mb-2">Do $41,100</p>
            ...
            <div className="flex flex-col md:flex-row md:items-start gap-6">
              <div className="flex-1">
                ...
                <div className="bg-green-50 border border-green-200 rounded-xl p-4 mb-4">
                  <p className="text-xs text-green-600 font-semibold uppercase tracking-wide mb-1">Bonus rejestracyjny</p>
      ...
      <div className="bg-white border border-gray-100 rounded-2xl p-6 mb-8">
        ...
        <div className="space-y-4">
          {[
            ...
            { q: 'Czy KYC jest wymagane do bonusu?', a: 'Na większości giełd weryfikacja KYC jest wymagana do wypłaty środków i pełnego bonusu.' },
            { q: 'Ile czasu zajmuje rejestracja?', a: 'Rejestracja zajmuje 5 minut. Weryfikacja — od 30 minut do 24 godzin.' },
            { q: 'Czy bonusy są naprawdę bezpłatne?', a: 'Tak, rejestracja jest bezpłatna. Niektóre bonusy wymagają pierwszego depozytu.' },
          ].map(({ q, a }) => (

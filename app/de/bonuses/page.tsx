  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-10">
      <div className="text-center mb-12">
        <span className="inline-block bg-green-100 text-green-700 text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wide mb-4">Aktuell — Mai 2026</span>
        <h1 className="text-4xl md:text-5xl font-black text-gray-900 mb-4">🎁 Registrierungsboni</h1>
        <p className="text-gray-500 text-lg max-w-2xl mx-auto">Vergleiche Boni der Top-Börsen. Registriere dich über unsere Links und erhalte den maximalen Bonus.</p>
      </div>
      <div className="bg-gradient-to-r from-orange-500 to-orange-600 rounded-2xl p-6 mb-10 text-white text-center">
        <p className="text-sm font-semibold uppercase tracking-wide opacity-80 mb-1">Gesamtpotenzial Bonus</p>
        <p className="text-5xl font-black mb-2">Bis zu $41,100</p>
      ...
      <div className="bg-white border border-gray-100 rounded-2xl p-6 mb-8">
        ...
        <div className="space-y-4">
          {[
            ...
            { q: 'Ist KYC für den Bonus erforderlich?', a: 'Bei den meisten Börsen ist die KYC-Verifizierung für Auszahlungen und den vollen Bonus erforderlich.' },
            { q: 'Wie lange dauert die Registrierung?', a: 'Die Registrierung dauert 5 Minuten. Verifizierung — von 30 Minuten bis 24 Stunden.' },
            { q: 'Sind die Boni wirklich kostenlos?', a: 'Ja, die Registrierung ist kostenlos. Einige Boni erfordern eine erste Einzahlung.' },
          ].map(({ q, a }) => (

...
<div style="max-width:600px;margin:0 auto;padding:20px;">
  ...
  <div style="background:#eff6ff;padding:24px;text-align:center;border-left:4px solid #3b82f6;">
    ...
    <a href="${getAffiliateLink('kucoin')}" style="background:#2563eb;color:white;padding:12px 32px;border-radius:8px;text-decoration:none;font-weight:bold;display:inline-block;margin:4px;">KuCoin →</a>
  </div>
